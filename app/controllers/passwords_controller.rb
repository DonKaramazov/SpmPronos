class PasswordsController < ApplicationController
    ...
    def create
        ...
        if @user
            ...
            redirect_to new_session_path, success: 'Un email vous a été envoyé pour la réinitialisation de votre mot de passe'
        else
    ...
    def edit
        ...
        if params[:token].nil? || @user.recover_password != params[:token]
            redirect_to new_password_path, danger:"Le token n'est pas valide."
        end
    end
    ...
    def update
        ...
        if !user_params[:recover_password].nil? && @user.recover_password === user_params[:recover_password]
